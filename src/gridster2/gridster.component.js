    ...
    function GridsterController($element, GridsterConfig, GridsterUtils, $log, $scope, GridsterEmptyCell, GridsterCompact) {
        ...
        vm.$onChanges = function(changes) {
            if (changes.options) {
                ...
                vm.options.api = {
                    ...
                    getCompactPossiblePosition: vm.getCompactPossiblePosition
                };
        ...
        vm.$onDestroy = function() {
            ...
            if (vm.options.api) {
                ...
                vm.options.api.getCompactPossiblePosition = undefined;
        ...
        vm.setGridDimensions = function setGridDimensions() {
            ...
            var rows = vm.$options.minRows,
                columns = vm.$options.minCols;
        ...
        vm.getCompactPossiblePosition = function getCompactPossiblePosition(newItem) {
            if (newItem.cols === undefined) {
                newItem.cols = vm.$options.defaultItemCols;
            }
            if (newItem.rows === undefined) {
            ...
            for (; rowsIndex < vm.rows; rowsIndex++) {
                newItem.y = rowsIndex;
                colsIndex = 0;
                for (; colsIndex < vm.$options.maxCols; colsIndex++) {
                    newItem.x = colsIndex;
                    if (!vm.checkCollision(newItem)) {
                        return true;
                    }
